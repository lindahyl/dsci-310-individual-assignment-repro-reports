...
```{r horse-population, out.width="100%", echo = FALSE, fig.cap = "Horse populations for all provinces in Canada from 1906 - 1972"}
...
```{r horses-sd-table, echo = FALSE, message = FALSE, fig.cap = "Horse populations Standard Deviation"}
